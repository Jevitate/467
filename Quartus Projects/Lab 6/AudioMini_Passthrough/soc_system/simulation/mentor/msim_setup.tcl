...
# ----------------------------------------
# ACDS 18.1 625 win32 2019.11.12.12:17:17
...
ensure_lib                       ./libraries/PLL_using_AD1939_MCLK/
vmap       PLL_using_AD1939_MCLK ./libraries/PLL_using_AD1939_MCLK/
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_PLL_using_AD1939_MCLK.vho" -work PLL_using_AD1939_MCLK
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L PLL_using_AD1939_MCLK -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L PLL_using_AD1939_MCLK -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
