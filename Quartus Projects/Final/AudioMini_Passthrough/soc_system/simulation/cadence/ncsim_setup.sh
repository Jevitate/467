...
mkdir -p ./libraries/PLL_using_AD1939_MCLK/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_PLL_using_AD1939_MCLK.vho" -work PLL_using_AD1939_MCLK -cdslib ./cds_libs/PLL_using_AD1939_MCLK.cds.lib
